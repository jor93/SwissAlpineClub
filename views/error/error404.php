					...
					<div class="head-nav">
						<span class="menu"> </span>
							<ul>
								...
								<li class="active"><a href="error404.php">Blog</a></li>
	...
	<div class="main">
		...
		<!--start-plans-404page---->
			<div class="error-page">
				<p>Page Not Found!</p>
				<h3>404</h3>
				<a href="index.html" class="go">Go home</a>
			</div>
			<!--End-plans-404page---->	
		</div>
	</div>
		...
		<div class="col-md-3 information">
				...
				<div class="nav-bottom">
						<ul>
							...
							<li><a href="news.html">News</a></li>
							<li><a href="events.html">Events</a></li>
							<li><a href="error404.php">Blog</a></li>
							<li><a href="contact.html">Contacts</a></li>
								<div class="clearfix"></div>	
						</ul>
					</div>
			...
			<div class="col-md-3 conta">
				...
				<div class="clearfix"> </div>
			<div class="bottom">
				<p>Copyrights © 2015 Hiking All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
	</div>
<!-- footer -->
