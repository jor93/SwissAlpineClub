            ...
            <form action="<?php echo URL_DIR . 'tour/updateTour'; ?>" id="manageTour" method="post"
                ...
                <div class="register-top-grid">
                    ...
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <input type="text" onkeypress='return validateQty(event);' id="dur" name="duration"
                               value="<?php echo $tour->getDuration(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_ZIPDEP']; ?></span>
                        <input type="text" id="plz_dep" name="postcodeDep"
                               value="<?php echo $tour->getLocationDep()->getPostcode(); ?>" required disabled>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_LOCDEP']; ?></span>
                        <input type="text" id="loc_dep" name="locationDep"
                               value="<?php echo $tour->getLocationDep()->getLocationName(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_ZIPARR']; ?></span>
                        <input type="text" id="plz_arr" name="postcodeArriv"
                               value="<?php echo $tour->getLocationArriv()->getPostcode(); ?>" required disabled>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_LOCARR']; ?></span>
                        <input type="text" id="loc_arr" name="locationArriv"
                               value="<?php echo $tour->getLocationArriv()->getLocationName(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_PRICE']; ?></span>
                        <input type="text" onkeypress='return validateQty(event);' id="price" name="price"
                               value="<?php echo $tour->getPrice(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_DESCDE']; ?></span>
                        <input class="MyClass" type="text" id="descDE" name="descDE"
                               value="<?php echo $tour->getLanguageDescriptionDE(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_DESCFR']; ?></span>
                        <input type="text" id="descFR" name="descFR"
                               value="<?php echo $tour->getLanguageDescriptionFR(); ?>" disabled required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                    ...
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <input type="text" id="deptime" name="deptime" value="<?php echo substr($tour->getDepartTime(), 0, -3); ?>"
                               disabled required>
                        <label id="selectCheckTimeDep" class="error" style="display:none">Invalid time format</label>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <input type="text" id="artime" name="artime" value="<?php echo substr($tour->getArrivalTime(), 0, -3); ?>"
                               disabled required>
                        <label id="selectCheckTimeAr" class="error" style="display:none">Invalid time format</label>
                    </div>
                    ...
                    <div class="wow fadeInRight" data-wow-delay="0.4s">
                        ...
                        <fieldset id="fieldtour" name="fieldtour" disabled>
                            ...
                            <label id="selectCheck" class="error" style="display:none">Please choose at least one
                                type</label>
                        </fieldset>
                    </div>
                    ...
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <label id="selectImageCheck" class="error" style="display:none">File too big</label>
                    </div>

                    <!-- gez: for inscription necessary infos! -->
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_EXPDATE']; ?></span>
                        <input type="text" id="exdate" name="exdate" disabled
                               value="<?php echo $inscription->getExpirationDate(); ?>" required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                        <span><?php echo $lang['SHOWHIKEADMIN_AVPLACE']; ?></span>
                        <input type="number" id="a_places" name="a_places" disabled
                               value="<?php echo $inscription->getMaxInscriptions(); ?>" required>
                    </div>
                    <div class="wow fadeInLeft" data-wow-delay="0.4s">
                ...
                <div class="register-but">
                    <button id="btn-save" type="submit" class="btn btn-primary"
                            style="display: none"><?php echo $lang['SHOWADMIN_SAVE']; ?></button>
