    ...
    set: function(newVal){
      ...
      if(!this._settings.range){
        ...
        this._elements.each(function(i,el){
          var $el = $(el);
          if(self1._settings.direction == "vertical"){
          ...
          $el.find(".addui-slider-handle").eq(0).find(".addui-slider-value span").html(toFunc(self1._settings.formatter).call(self1, l));
          $el.find(".addui-slider-handle").eq(1).find(".addui-slider-value span").html(toFunc(self1._settings.formatter).call(self1, h));
        });
      }
    }
  });
