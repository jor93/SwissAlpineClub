    ...
    */
    $.fn.filterizr.prototype = {
        ...
        */
        ...
        /**
         * Range filters on/off and renders the new collection
         */
        rangeFilter: function() {

            window.alert(1234567);
            var self   = this,
                target = self._getCollectionByFilter(targetFilter);

            var val = $("[data-addui=slider]").val(a);
            ...
            //If undefined (in case of window resize) ignore
            if (rangedFilter) {
                if (!self._toggledCategories[rangedFilter])
                    self._toggledCategories[rangedFilter] = true;
                else
                    delete self._toggledCategories[rangedFilter];
            }
        ...
        */
        _setupControls: function() {
            ...
            $('input[range-filter]').click(function() {
                window.alert(5 + 6);
                self.rangeFilter();
